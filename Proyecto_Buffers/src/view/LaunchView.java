...
public class LaunchView extends JFrame {
	...
	private JLabel lblInserteElPrefijo;
	...
	public LaunchView() {
		...
		btnBuscarPrefijo.addActionListener(new ActionListener() {
		...
		lblInserteElPrefijo = new JLabel("Inserte el prefijo:");
		panel.add(lblInserteElPrefijo);
